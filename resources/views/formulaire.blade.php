      ...
      <div class="form-content">
        <form id="medical-form" method="POST" action="{{ route('demandes.store') }}">
          ...
          <div class="form-group">
            ...
            <input type="date" class="form-control" name="donnees_medicales[informations_personnelles][date_naissance]" id="date-naissance" max="2025-08-10" required>
            <div class="error-message" id="date-naissance-error"></div>
          </div>
          
          <div class="form-group">
            <label for="sexe"><i class="fas fa-venus-mars"></i> Sexe</label>
            <select class="form-control" name="donnees_medicales[informations_personnelles][sexe]" id="sexe" required>
          ...
          <!-- Couverture Santé -->
          <div class="form-group">
            <label for="couverture-sante"><i class="fas fa-shield-alt"></i> Avez-vous déjà bénéficié d'une couverture santé ?</label>
            <div>
          ...
          <div class="form-group">
            <label for="depenses-sante"><i class="fas fa-money-bill-wave"></i> Coût mensuel estimatif de vos dépenses en santé (FCFA)</label>
          ...
          <div class="form-group">
            <label for="lunettes"><i class="fas fa-glasses"></i> Portez-vous des lunettes ?</label>
            <div>
              <div class="form-check form-check-inline">
          ...
          <div class="form-group">
            ...
            <textarea class="form-control" name="donnees_medicales[allergies_antecedents][allergies]" id="allergies" rows="2" placeholder="Listez vos allergies ou tapez 'Aucune'" required></textarea>
          ...
          <!-- Mode de Vie -->
          <div class="form-group">
            <label><i class="fas fa-leaf"></i> Mode de vie</label>
  ...
  <script>
    ...
    sexeInput.addEventListener('change', () => {
      if (sexeInput.value === 'F') {
        ...
        gynecologieSection.querySelectorAll('input, select, textarea').forEach(input => {
